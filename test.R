...
# J'ai mis les descriptions et les noms des différents événement et qualifier pour que ce soit compréhensible, mais pour faire tourner nos modèles on utilisera les ID (performance + correspond au fichier sample)
events <- dbGetQuery(con, "select dq.nom qualifier,dq.description,dq.valeur,q.valeur,e.type_id,de.nom evenement,de.description,e.type_id,e.period_id,e.minuts,e.sec,e.idteam,e.outcome,e.x,e.y,e.t_timestamp,home_team_name,away_team_name,competition_name,game_date, period_1_start, period_2_start, eq.nom equipe_joueur,j1.nom joueur,j1.poste,j1.real_position,j1.real_position_side
from qualifier q
...
left join dimevent de on de.eventid=e.type_id
limit 1000")
events